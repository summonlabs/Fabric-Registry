// Fabric Registry — real operating-system process control for tests.
//
// Copyright 2026 Summon Software Labs.
// Licensed under the Apache License, Version 2.0.
//
// The multiprocess proofs must kill real processes, so this helper starts a real
// child with an independent address space and terminates it with the operating
// system's own forced-termination call. Nothing here simulates process death.

#ifndef FABRIC_REGISTRY_TESTS_SUPPORT_TEST_PROCESS_HPP
#define FABRIC_REGISTRY_TESTS_SUPPORT_TEST_PROCESS_HPP
...
public:
  ...
  /// captured; standard input is a pipe the parent holds open.
...
/// Removes every file whose name begins with \`prefix\` inside \`directory\`.
void remove_files_with_prefix(const std::string& directory, const std::string& prefix);
...
#endif // FABRIC_REGISTRY_TESTS_SUPPORT_TEST_PROCESS_HPP
